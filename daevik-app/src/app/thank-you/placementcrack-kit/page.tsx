...
export default async function PlacementCrackKitThankYou({
  searchParams,
}: {
        ...
        <div className="ty-card ty-main-card">
          ...
          <div className="ty-summary-box">
            ...
            <div className="ty-summary-row">
              ...
              <span className="ty-summary-value ty-amount">₹{order?.amount || '199'}</span>
            </div>
          </div>

          {downloadUrl ? (
            <div className="ty-download-section">
              <h2 className="ty-section-title">Your digital bundle is ready</h2>
  ...
  return (
    <style dangerouslySetInnerHTML={{ __html: `
      :root {
        ...
        --ty-white: #FFFFFF;
        --ty-emerald: #10B981;
        --ty-emerald-hover: #059669;
        --ty-emerald-light: #D1FAE5;
        --ty-blue: #4F46E5;
        --ty-text: #0F172A;
      ...
      * {
      ...
      /* In Next.js, DownloadButton component renders a button with class "ty-btn ty-btn-primary" */
      .ty-btn-primary {
