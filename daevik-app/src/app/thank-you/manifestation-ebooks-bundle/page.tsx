...
export default async function ManifestationEbooksThankYou({
  searchParams,
}: {
  ...
  return (
    <style dangerouslySetInnerHTML={{ __html: `
      :root {
        --ty-bg: #F4F1FA;
        --ty-white: #FFFFFF;
        --ty-emerald: #D4AF37; /* Gold */
        --ty-emerald-hover: #C5A028;
        --ty-emerald-light: #FDF9E7;
        --ty-text: #2D1B4E;
        --ty-text-secondary: #4B3C6A;
        --ty-text-muted: #6B5B95;
        --ty-border: #D1C4E9;
        --ty-error: #DC2626;
        --ty-error-bg: #FEF2F2;
