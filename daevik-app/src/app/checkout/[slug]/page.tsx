  ...
  return (
    <div className="checkout-layout">
      <div className="checkout-container" style={{ maxWidth: product.checkout_page_html ? '1000px' : '480px' }}>
        {/* Header */}
        <div className="checkout-header" style={{ marginBottom: 'var(--space-12)' }}>
        ...
        <div style={{ display: 'flex', gap: 'var(--space-12)', flexDirection: 'row', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          {product.checkout_page_html && (
            <div className="checkout-custom-html animate-fade-in-up" style={{ flex: '1 1 400px' }}>
              <span className="eyebrow">Product Details</span>
              <div dangerouslySetInnerHTML={{ __html: product.checkout_page_html }} />
            </div>
          )}
